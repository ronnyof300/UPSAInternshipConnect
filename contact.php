...
<head>
	...
	<title>UPSA Internship Connect - Contact Us</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="job-list.php">Internship Opportunities</a>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> UPSA <br/> PO.BOX, <br/>LEGON-ACCRA</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">UPSA Internship Connect@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+233 000 000 00</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About UPSA Internship Connect</h5>
											<p>UPSA Internship Connectis a job portal, online job management system Developed by Gladys Ivy Mensah, Clinton Horlanyo Bansah, Ransford Kofi Anane</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">UPSA Internship Connect Contact</h5>
								
								<p>Address : UPSA</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">UPSA Internship Connect@gmail.com</a></p>
								<p>Phone : <a href="tel:+233 24 841 9301">+233 00 000 000</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169;  <?php echo date('Y'); ?> </p>
